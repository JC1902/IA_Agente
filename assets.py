...
#muk = [ pygame.transform.scale( imagen, ( CELL_SIZE / 2, CELL_SIZE / 2 ) ) for imagen in muk ]

voltorb = [ pygame.image.load( f'enemigos/pozoV40_{i}.png' ) for i in range(6) ]
#voltorb = [ pygame.transform.scale( imagen, ( CELL_SIZE / 2, CELL_SIZE / 2 ) ) for imagen in voltorb ]
